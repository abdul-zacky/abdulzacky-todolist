            ...
            children: [
              if (widget.initialToDo != null)
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(primary: Colors.red, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),
                  child: const Text(
                    'DELETE',
              ...
              ElevatedButton(
                ...
                child: Text(widget.initialToDo != null ? 'SAVE' : 'ADD'),
              ),
            ],
          )
        ],
